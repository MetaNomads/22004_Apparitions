...
namespace Autohand{
    public class TeleportToSoul : MonoBehaviour{
        public static bool isSoul = false;
        [Header("Teleport")]
        ...
        public void StartTeleport(){
            if (!isSoul) {
                ...
                playerBody?.SetPosition(myBody.transform.position);
                playerBody?.SetRotation(myBody.transform.rotation);
                Destroy(myBody);
                isSoul = false;
            }
        }
        ...
        public void Teleport(){
            ...
            if(hitting) {
                ...
                myBody = Instantiate(bodyPrefab, playerBody.body.position, Quaternion.LookRotation(aimHit.point - playerBody.body.position));
                isSoul = true;
                playerBody?.SetPosition(aimHit.point);
                playerBody?.SetRotation(Quaternion.LookRotation(myBody.transform.position - playerBody.body.position));
